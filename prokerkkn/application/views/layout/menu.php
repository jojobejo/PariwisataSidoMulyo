...
<div class="row">
<div class="main-menu">
<a class="show-res-logo" href="<?php echo base_url() ?>"><img src="" alt="logo" class="img-responsive" style="max-height: 76px; width: auto;" /></a>
<nav class="navbar">
    ...
    <span class="icon-bar"></span>
        ...
        <a class="navbar-brand" href="<?php echo base_url() ?>"><img src="" alt="logo" class="img-responsive" style="max-height: 56px; width: auto;" /></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <!-- PROFIL -->
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">PARIWISATA<span class="caret"></span></a>
